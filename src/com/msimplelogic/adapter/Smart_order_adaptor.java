...
public class Smart_order_adaptor extends RecyclerView.Adapter<Smart_order_adaptor.MyViewHolder> {
  ...
  //  ProgressDialog progress = new ProgressDialog(context);
    ...
    public Smart_order_adaptor(Context context, List<Smart_order_model> array) {
