...
public class Quick_order_adaptor extends RecyclerView.Adapter<Quick_order_adaptor.MyViewHolder> {
    ...
    Quick_order_adaptor.customButtonListener customListner;
    String q_check = "";
    String str;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView showUpdateStock;
        ...
        //    plus_btn = (ImageView) view.findViewById(R.id.plus_btn);
          //  minus_btn = (ImageView) view.findViewById(R.id.minus_btn);
            ...
            schemeBtn = (Button) view.findViewById(R.id.scheme_btn);
    ...
    public void setCustomButtonListner(Quick_order_adaptor.customButtonListener listener) {
        this.customListner = listener;
    }

    public Quick_order_adaptor(Context context, List<Catalogue_model> catalogue_m, Catalogue_slider_caller listener) {
        mContext = context;
    ...
    @Override
    public Quick_order_adaptor.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_quick_order, parent, false);
        return new Quick_order_adaptor.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Quick_order_adaptor.MyViewHolder holder, final int position) {
...
//        }
        ...
        rpstr=Global_Data.rpquickorder;
        mrpstr=Global_Data.mrpquickorder;
        if (rpstr.length() > 0) {
