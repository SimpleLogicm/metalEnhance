...
import com.msimplelogic.activities.OnlineCatalogue;
...
public class swipCatalauge_Adapter extends PagerAdapter {
    ...
    //private List<SwipeImage> catalogue_m1;
    private Activity _activity;
    //ImageSwitcher Switch;
    private LayoutInflater inflater;
    TextView vdialogMrp, vdialogRp, vdialogPid, vdialogPrdname, vpp_mrp, vpp_rp, vimg_url, flip_img, eprice_dialog, ediscountprice_dialog,prodDesc;
    ImageView vdialogImage, vdialogPlus, vdialogMinus, vdialogClose;
    TextView edit_value;
    Button vdialogSave;

    // constructor
    public swipCatalauge_Adapter(Activity activity,
                                 List<Catalogue_model> catalogue_m) {
        this._activity = activity;
        this.catalogue_m = catalogue_m;
        //this.catalogue_m1 = catalogue_m1;
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        //Switch = (ImageSwitcher)viewLayout.findViewById(R.id.imageSwitcher);
        ...
        prodDesc = (TextView) viewLayout.findViewById(R.id.prodnamedesc_doalog);
        ...
        //final SwipeImage catalogue_mm1 = catalogue_m1.get(position);

        prodDesc.setMovementMethod(new ScrollingMovementMethod());
...
//        price_str=spf1.getString("var_total_price", "");
        ...
        vdialogPrdname.setText(Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(catalogue_mm.getItem_name()));

        String prodDescStr=Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(catalogue_mm.getItem_description());


        if(!prodDescStr.equalsIgnoreCase(null) && !prodDescStr.equalsIgnoreCase(""))
        {
            prodDesc.setVisibility(View.VISIBLE);
            prodDesc.setText(Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(catalogue_mm.getItem_description()));
        }else {
            prodDesc.setVisibility(View.GONE);
        }
...
//        }
        ...
        vdialogSave.setOnClickListener(new View.OnClickListener() {
            @Override
...
//
//                if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(edit_value.getText().toString()) && Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(vdialogMrp.getText().toString())) {
//
//                    try {
//
////                        if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(remark_dialog.getText().toString())) {
////                            Global_Data.Orderproduct_remarks.put(position + "&" + vdialogPid.getText().toString(), remark_dialog.getText().toString());
////                        }
////                        if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(edit_detail5.getText().toString().toString())) {
////                            Global_Data.Orderproduct_detail5.put(position + "&" + vdialogPid.getText().toString(), edit_detail5.getText().toString().toString());
////                        }
////
////                        if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(edit_detail1.getText().toString())) {
////                            Global_Data.Orderproduct_detail1.put(position + "&" + vdialogPid.getText().toString(), edit_detail1.getText().toString());
////                        }
////
////                        if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(edit_detail3.getText().toString())) {
////                            Global_Data.Orderproduct_detail3.put(position + "&" + vdialogPid.getText().toString(), edit_detail3.getText().toString());
////                        }
////
////                        if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(edit_detail4.getText().toString())) {
////                            Global_Data.Orderproduct_detail4.put(position + "&" + vdialogPid.getText().toString(), edit_detail4.getText().toString());
////                        }
////
////                        if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanew(edit_detail2.getText().toString())) {
////                            Global_Data.Orderproduct_detail2.put(position + "&" + vdialogPid.getText().toString(), edit_detail2.getText().toString());
////                        }
//
//                        Double value = Double.valueOf(edit_value.getText().toString()) * Double.valueOf(vdialogMrp.getText().toString());
...
//
//                            ediscountprice_dialog.setText(_activity.getResources().getString(R.string.DISCOUNT_PRICE) + String.valueOf(value-(Double.valueOf(image.getScheme_amount())*Double.valueOf(edit_value.getText().toString()))));
//
//                            Global_Data.Order_hashmap.put(position + "&" + vdialogPid.getText().toString(), s.toString() + "pq" + String.valueOf(value-(Double.valueOf(catalogue_mm.getScheme_amount())*Double.valueOf(edit_value.getText().toString()))) + "pprice" + vdialogText.getText().toString() + "pmrp" + vdialogMrp.getText().toString() + "prp" + vdialogRp.getText().toString() + "sid" + catalogue_mm.getScheme_id()+ "url" + vimg_url.getText().toString());
//
...
//
//                            Global_Data.Order_hashmap.put(position + "&" + vdialogPid.getText().toString(), s.toString() + "pq" + String.valueOf(res) + "pprice" + vdialogText.getText().toString() + "pmrp" + vdialogMrp.getText().toString() + "prp" + vdialogRp.getText().toString() + "sid" + catalogue_mm.getScheme_id()+ "url" + vimg_url.getText().toString());
//
...
//                            double aaa =(Double.valueOf(edit_value.getText().toString()) / Double.valueOf(image.getScheme_buy_qty())) + Double.valueOf(edit_value.getText().toString());
//                            int y=(int)aaa;
//                            //Toast.makeText(_activity, ""+y, Toast.LENGTH_SHORT).show();
//
//                            Global_Data.Order_hashmap.put(position + "&" + vdialogPid.getText().toString(), y + "pq" + String.valueOf(value) + "pprice" + vdialogText.getText().toString() + "pmrp" + vdialogMrp.getText().toString() + "prp" + vdialogRp.getText().toString() + "sid" + catalogue_mm.getScheme_id()+ "url" + vimg_url.getText().toString());
//
...
//                        }else{
//                            Global_Data.Order_hashmap.put(position + "&" + vdialogPid.getText().toString(), s.toString() + "pq" + String.valueOf(value) + "pprice" + vdialogText.getText().toString() + "pmrp" + vdialogMrp.getText().toString() + "prp" + vdialogRp.getText().toString() + "sid" + catalogue_mm.getScheme_id()+ "url" + vimg_url.getText().toString());
//
//                        }
//
...
//                    Global_Data.Order_hashmap.put(position + "&" + vdialogPid.getText().toString(), "");
//                }
//            }
//        });
                                ...
                                if((Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(image.getScheme_type())).equalsIgnoreCase("value_scheme"))
                                {
                                    ...
                                    if(minSchemeQty.length()>0)
                                    {
                                        if(Double.valueOf(dialogEdit.getText().toString())>=Double.valueOf(minSchemeQty))
                                        {
                                            ...
                                            Global_Data.Order_hashmap.put(position + "&" + dialogPid.getText().toString(), s.toString() + "pq" + String.valueOf(value-(Double.valueOf(catalogue_mm.getScheme_amount()))) + "pprice" + dialogText.getText().toString() + "pmrp" + emrp_dialog.getText().toString() + "prp" + erp_dialog.getText().toString() + "sid" + catalogue_mm.getScheme_id()+ "url" + vimg_url.getText().toString());
...
//                }
        ...
        vdialogClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent goToNewOrderActivity = new Intent(_activity, OnlineCatalogue.class);
