...
public class CustomerAnalysisPieActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customer_pie_main);
        ...
        try {
            ...
            SharedPreferences sp = CustomerAnalysisPieActivity.this.getSharedPreferences("SimpleLogic", 0);
...
//	       	todaysTarget.setText("Today's Target Acheived: Rs "+(sp.getFloat("Current_Target", 0.00f)-sp.getFloat("Target", 0.00f))+"");
        ...
        barchartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CustomerAnalysisPieActivity.this, CustomerAnalysisActivity.class);
        ...
        filterPieBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CustomerAnalysisPieActivity.this, FilterCustomerSearchActivity.class);
                startActivity(intent);
            }
        });
...
//        }
        ...
        for(int i=0; i< Global_Data.FINAL_PI_X.size(); i++)
        {
           ...
           // entries.add(new PieEntry(Float.valueOf(Global_Data.FINAL_PI_Y.get(i)), ""));
        }
...
//        entries.add(new PieEntry((float) (88), DemoBase.mPartiesnew[3]));
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("Customer Analysis");
...
//		return super.onOptionsItemSelected(item);
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(CustomerAnalysisPieActivity.this,DashboardActivity.class);
