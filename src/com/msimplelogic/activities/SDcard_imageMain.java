...
import com.msimplelogic.imageadapters.AlbumsAdapter;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

public class SDcard_imageMain extends BaseActivity {
...
//                        Log.d("all file path" + i, allFiles[i] + allFiles.length);
                       ...
                       if(details.size() > 0) {
                           for (Local_Data cn : details) {
                               ...
                               //  Album a = new Album(c_details,"",mediaStorageDir.getPath()+"/"+ allFiles[i]);
                        ...
                        {
                          // Toast.makeText(SDcard_imageMain.this, getResources().getString(R.string.Image_Not_Found), Toast.LENGTH_SHORT).show();
                           Global_Data.Custom_Toast(SDcard_imageMain.this, getResources().getString(R.string.Image_Not_Found),"");
                           Intent i=new Intent(SDcard_imageMain.this, Customer_Feed.class);
