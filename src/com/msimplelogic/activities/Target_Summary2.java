...
public class Target_Summary2 extends BaseActivity {
    int check=0;
    int check_product=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_target_summary2);
...
//                Intent i=new Intent(Target_Summary2.this, ActivityViewTarget.class);
...
//                startActivity(i);
        ...
        ts2more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i=new Intent(Target_Summary2.this, Target_REYCLE.class);
                    i.putExtra("FROM_YEAR", FROM_YEAR);
                    i.putExtra("FROM_MONTH", FROM_MONTH);
                    i.putExtra("TO_YEAR", TO_YEAR);
                    i.putExtra("TO_MONTH", TO_MONTH);
                    i.putExtra("FROM_DATE", FROM_DATE);
                    i.putExtra("TO_DATE", TO_DATE);
                ...
                {
//                    Toast toast = Toast.makeText(Target_Summary2.this, getResources().getString(R.string.internet_connection_error), Toast.LENGTH_LONG);
//                    toast.setGravity(Gravity.CENTER, 0, 0);
//                    toast.show();

                    Global_Data.Custom_Toast(Target_Summary2.this, getResources().getString(R.string.internet_connection_error),"yes");
...
//        T_from_date.setText(FROM_MONTH+" " + FROM_YEAR);
//        T_to_date.setText(TO_MONTH);
        ...
        if (isInternetPresent)
        {
           getTargetDataSummary2(FROM_YEAR,FROM_MONTH,TO_YEAR,TO_MONTH);
        }
        else
        {
//            Toast toast = Toast.makeText(Target_Summary2.this, getResources().getString(R.string.internet_connection_error), Toast.LENGTH_LONG);
...
//        });
        ...
        SharedPreferences spf = Target_Summary2.this.getSharedPreferences("SimpleLogic", 0);
...
//            SharedPreferences sp = Target_Summary2.this.getSharedPreferences("SimpleLogic", 0);
//
...
//        startActivity(i);
    ...
    public void getTargetDataSummary2(String fromYear, String fromMonth, String toYear,String toMonth)
    {
        result.clear();
        loginDataBaseAdapter=new LoginDataBaseAdapter(Target_Summary2.this);
        loginDataBaseAdapter=loginDataBaseAdapter.open();
...
//            String T_TO_MONTH = String.valueOf(cal2.get(Calendar.MONTH)+1);
            ...
            {
                service_url = domain+"targets/get_targets_by_product?email="+user_email+"&from_year="+fromYear+"&from_month="+fromMonth+"&to_year="+toYear+"&to_month="+toMonth+"&primary_category="+URLEncoder.encode(product_category_final, "UTF-8")+"&product_sub_category=true";
            }
            else
            {
                service_url = domain+"targets/get_targets?email="+user_email+"&from_year="+fromYear+"&from_month="+fromMonth+"&to_year="+toYear+"&to_month="+toMonth+"&primary_category="+URLEncoder.encode(product_category_final, "UTF-8")+"&product_category=true";
            }
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try{
                        ...
                        if(response_result.equalsIgnoreCase("User doesn't exist")) {
                            ...
                            dialog.dismiss();
//                            Toast toast = Toast.makeText(Target_Summary2.this, response_result, Toast.LENGTH_LONG);
//                            toast.setGravity(Gravity.CENTER, 0, 0);
//                            toast.show();

                            Global_Data.Custom_Toast(Target_Summary2.this, response_result,"yes");
...
//                                Toast toast = Toast.makeText(Target_Summary2.this, getResources().getString(R.string.Target_not_found), Toast.LENGTH_LONG);
//                                toast.setGravity(Gravity.CENTER, 0, 0);
//                                toast.show();

                                Global_Data.Custom_Toast(Target_Summary2.this, getResources().getString(R.string.Target_not_found),"yes");
...
//                                            agen_total +=  (Double.valueOf(jsonObject.getString("achieved").toString()))/(Double.valueOf(jsonObject.getString("target").toString()));
                                ...
                                GrpbyMore_Adapter ca = new GrpbyMore_Adapter(Target_Summary2.this, result);
                                recList.setAdapter(ca);
                               // ca.notifyDataSetChanged();
...
//                    Toast toast = Toast.makeText(Target_Summary2.this, getResources().getString(R.string.Server_Error), Toast.LENGTH_LONG);
//                    toast.setGravity(Gravity.CENTER, 0, 0);
//                    toast.show();
                    Global_Data.Custom_Toast(Target_Summary2.this, getResources().getString(R.string.Server_Error),"yes");
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Target_Summary2.this);
