...
public class PermissionsActivity extends BaseActivity {
    ...
    private void showMissingPermissionDialog() {
        ...
        dialogBuilder.setTitle(R.string.need_permission_message);
        dialogBuilder.setMessage(R.string.need_permission_message);
        dialogBuilder.setNegativeButton(R.string.need_permission_message, new DialogInterface.OnClickListener() {
            @Override
