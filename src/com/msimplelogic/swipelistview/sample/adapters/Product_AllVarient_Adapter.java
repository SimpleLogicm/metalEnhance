...
public class Product_AllVarient_Adapter extends ArrayAdapter<HashMap<String, String>> {
    ...
    public Product_AllVarient_Adapter(Context context, ArrayList<HashMap<String, String>> dataItem1, ArrayList<String> list1, ArrayList<String> list2, ArrayList<String> list3, ArrayList<String> list4, ArrayList<String> list5, ArrayList<String> list6, ArrayList<String> list7, ArrayList<String> list8, ArrayList<String> list9) {
...
//    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = li.inflate(R.layout.new_productvarient, parent, false);
            ...
            holder.show_update_stock = (ImageView) convertView.findViewById(R.id.show_update_stock);
            //holder.edit_comments = (EditText) convertView.findViewById(R.id.editText4);


            holder.show_update_stock.setOnClickListener(new View.OnClickListener() {
                @Override
...
//            holder.scheme.setAnimation(animation);
...
//        price_str=spf1.getString("var_total_price", "");
        ...
        if (rpstr.length() > 0) {
            holder.mrpvnew.setText(context.getResources().getString(R.string.CMRP) + getData.get(TAG_PRICE) + "  " + "[" + rpstr + "] : " + getData.get(TAG_RP) + "\n" + context.getResources().getString(R.string.MIN_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_MINQTY)) + "  " + context.getResources().getString(R.string.PKG_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_PKGQTY)));
        } else {
            holder.mrpvnew.setText(context.getResources().getString(R.string.CMRP) + getData.get(TAG_PRICE) + "  " + context.getResources().getString(R.string.CRP) + getData.get(TAG_RP) + "\n" + context.getResources().getString(R.string.MIN_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_MINQTY)) + "  " + context.getResources().getString(R.string.PKG_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_PKGQTY)));
        }

        if (mrpstr.length() > 0) {
            holder.mrpvnew.setText("[" + mrpstr + "] : " + getData.get(TAG_PRICE) + "  " + context.getResources().getString(R.string.CRP) + getData.get(TAG_RP) + "\n" + context.getResources().getString(R.string.MIN_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_MINQTY)) + "  " + context.getResources().getString(R.string.PKG_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_PKGQTY)));
        } else {
            holder.mrpvnew.setText(context.getResources().getString(R.string.CMRP) + getData.get(TAG_PRICE) + "  " + context.getResources().getString(R.string.CRP) + getData.get(TAG_RP) + "\n" + context.getResources().getString(R.string.MIN_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_MINQTY)) + "  " + context.getResources().getString(R.string.PKG_QTY) + Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJavanewzpochecck(getData.get(TAG_PKGQTY)));
        }
...
//                             }
                        holder.totalprice.setText(context.getResources().getString(R.string.VPrice) + String.valueOf(value));
