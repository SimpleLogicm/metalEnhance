...
public class PackageAdapter extends ArrayAdapter<HashMap<String, String>>{
    ...
    public PackageAdapter(Context context, ArrayList<HashMap<String, String>> dataItem1) {
        super(context, R.layout.adapter_newpreviewswipe, dataItem1);
...
//    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = li.inflate(R.layout.adapter_newpreviewswipe, parent, false);
        ...
        holder.bAction1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Global_Data.quickorderback=="yes"&& Global_Data.quickorderback!=""){
                        ...
                        if (Global_Data.quikeditdel=="Yes"&& Global_Data.quikeditdel!=""){
                            getData = dataAray.get(position);
                            ...
                            Global_Data.Custom_Toast(context, "Please Save Sign","Yes");
...
//				 String product_dec = "";
               ...
               // dialogPrice.setText("₹" + Global_Data.amount);
                    ...
                    if (Global_Data.quikeditdel=="Yes"&& Global_Data.quikeditdel!=""){
                        ...
                        alertDialog.setButton(Dialog.BUTTON_POSITIVE, context.getResources().getString(R.string.Yes), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                {
                                    if (Global_Data.quickorderback=="yes"&& Global_Data.quickorderback!=""){
                                        Intent goToNewOrderActivity = new Intent(context, QuickOrder.class);
                                ...
                                else
                                {
                                    ...
                                    if (Global_Data.quickorderback=="yes"&& Global_Data.quickorderback!=""){
                                        Checkout_quick_order.updateSum(sum);
                                        Intent goToNewOrderActivity = new Intent(context,Checkout_quick_order.class);
                                        context.startActivity(goToNewOrderActivity);
